...
import static org.xyy.net.sncp.SncpRequest.DEFAULT_HEADER;
import java.io.*;
...
import org.xyy.net.sncp.SncpAsyncHandler.DefaultSncpAsyncHandler;
import org.xyy.service.*;
import org.xyy.util.*;
import org.xyy.service.RpcCall;
...
public final class SncpDynServlet extends SncpServlet {
    ...
    public static abstract class SncpServletAction {
        ...
        protected org.xyy.util.Attribute[] paramAttrs; // 为null表示无RpcCall处理，index=0固定为null, 其他为参数标记的RpcCall回调方法
        ...
        public final void _callParameter(final BsonWriter out, final Object... params) {
            if (paramAttrs != null) {
                for (int i = 1; i < paramAttrs.length; i++) {
                    org.xyy.util.Attribute attr = paramAttrs[i];
        ...
        public static SncpServletAction create(final Service service, final DLong actionid, final Method method) {
            ...
            try {
                ...
                org.xyy.util.Attribute[] atts = new org.xyy.util.Attribute[ptypes.length + 1];
