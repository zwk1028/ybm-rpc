...
import org.xyy.net.sncp.SncpClient.SncpAction;
...
public abstract class Sncp {
    ...
    static final String FIELDPREFIX = "_xyy";
     ...
     *
     *      private AnyValue _xyy_conf;
     *
     *      private SncpClient _xyy_client;
     *
     *      &#64;Override
     *      public String toString() {
     *          return _xyy_selfstring == null ? super.toString() : _xyy_selfstring;
     *      }
     *
     *      &#64;Override
     *      public void createSomeThing(TestBean bean){
     *          this._xyy_createSomeThing(false, true, true, bean);
     *      }
     *
     *      &#64;SncpDyn(remote = false, index = 0)
     *      public void _xyy_createSomeThing(boolean selfrunnable, boolean samerunnable, boolean diffrunnable, TestBean bean){
     *          if(selfrunnable) super.createSomeThing(bean);
     *          if (_xyy_client== null) return;
     *          if (samerunnable) _xyy_client.remoteSameGroup(0, true, false, false, bean);
     *          if (diffrunnable) _xyy_client.remoteDiffGroup(0, true, true, false, bean);
     *      }
     *
     *      &#64;Override
     *      public String updateSomeThing(String id){
     *          return this._xyy_updateSomeThing(true, true, true, id);
     *      }
     *
     *      &#64;SncpDyn(remote = false, index = 1)
     *      public String _xyy_updateSomeThing(boolean selfrunnable, boolean samerunnable, boolean diffrunnable, String id){
     *          String rs = super.updateSomeThing(id);
     *          if (_xyy_client== null) return rs;
     *          if (samerunnable) _xyy_client.remoteSameGroup(1, true, false, false, id);
     *          if (diffrunnable) _xyy_client.remoteDiffGroup(1, true, true, false, id);
     *          return rs;
     *      }
     * }
     * </pre></blockquote>
     ...
     *      &#64;SncpDyn(remote = false, index = 0)
     *      public void _xyy_createSomeThing(boolean selfrunnable, boolean samerunnable, boolean diffrunnable, TestBean bean){
     *          _xyy_client.remote(0, selfrunnable, samerunnable, diffrunnable, bean);
     *      }
     *
     *      &#64;SncpDyn(remote = false, index = 1)
     *      public String _xyy_updateSomeThing(boolean selfrunnable, boolean samerunnable, boolean diffrunnable, String id){
     *          return _xyy_client.remote(1, selfrunnable, samerunnable, diffrunnable, id);
     *      }
     *
     *      &#64;Override
     *      public void createSomeThing(TestBean bean){
     *          _xyy_client.remote(2, bean);
     *      }
     *
     *      &#64;Override
     *      public String findSomeThing(){
     *          return _xyy_client.remote(3);
     *      }
     *
     *      &#64;Override
     *      public String updateSomeThing(String id){
     *          return  _xyy_client.remote(4, id);
     *      }
     * }
     * </pre></blockquote>
     *
