...
public final class Rest {
    ...
    static final String REST_SERVICE_FIELD_NAME = "_xyy_service";

    static final String REST_JSONCONVERT_FIELD_PREFIX = "_xyy_jsonconvert_";

    static final String REST_SERVICEMAP_FIELD_NAME = "_xyy_servicemap"; //如果只有name=""的Service资源，则实例中_servicemap必须为null

    private static final String REST_PARAMTYPES_FIELD_NAME = "_xyy_paramtypes"; //存在泛型的参数数组 Type[][] 第1维度是方法的下标， 第二维度是参数的下标
    ...
    static <T extends HttpServlet> T createRestWebSocketServlet(final ClassLoader classLoader, final Class<? extends WebSocket> webSocketType) {
        ...
        { //@Resource
            for (int i = 0; i < resourcesFields.size(); i++) {
                ...
                fv = cw.visitField(ACC_PRIVATE, "_xyy_resource_" + i, Type.getDescriptor(field.getType()), fieldType == field.getType() ? null : Utility.getTypeDescriptor(fieldType), null);
                {
        ...
        { //createWebSocket 方法
            mv = new AsmMethodVisitor(cw.visitMethod(ACC_PROTECTED, "createWebSocket", "()Lorg/xyy/net/http/WebSocket;", "<G::Ljava/io/Serializable;T:Ljava/lang/Object;>()Lorg/xyy/net/http/WebSocket<TG;TT;>;", null));
            mv.visitTypeInsn(NEW, newDynName + "$" + newDynWebSokcetSimpleName);
            mv.visitInsn(DUP);
            for (int i = 0; i < resourcesFields.size(); i++) {
                mv.visitVarInsn(ALOAD, 0);
                mv.visitFieldInsn(GETFIELD, newDynName, "_xyy_resource_" + i, Type.getDescriptor(resourcesFields.get(i).getType()));
            }
        ...
        { //createRestOnMessageConsumer
            mv = new AsmMethodVisitor(cw.visitMethod(ACC_PROTECTED, "createRestOnMessageConsumer", "()Ljava/util/function/BiConsumer;", "()Ljava/util/function/BiConsumer<Lorg/xyy/net/http/WebSocket;Ljava/lang/Object;>;", null));
        ...
        for (int i = 0; i < messageMethods.size(); i++) {  // _DyncXXXWebSocketMessage List
            ...
            { //toString
                ...
                mv.visitMethodInsn(INVOKESTATIC, "org/xyy/convert/json/JsonConvert", "root", "()Lorg/xyy/convert/json/JsonConvert;", false);
                mv.visitVarInsn(ALOAD, 0);
                mv.visitMethodInsn(INVOKEVIRTUAL, "org/xyy/convert/json/JsonConvert", "convertTo", "(Ljava/lang/Object;)Ljava/lang/String;", false);
                mv.visitInsn(ARETURN);
                mv.visitMaxs(2, 1);
                mv.visitEnd();
            }
        ...
        { //_DynRestOnMessageConsumer class
            ClassWriter cw2 = new ClassWriter(COMPUTE_FRAMES);
            cw2.visit(V1_8, ACC_PUBLIC + ACC_FINAL + ACC_SUPER, newDynConsumerFullName, "Ljava/lang/Object;Ljava/util/function/BiConsumer<Lorg/xyy/net/http/WebSocket;Ljava/lang/Object;>;", "java/lang/Object", new String[]{"java/util/function/BiConsumer"});
            ...
            { //accept函数
                mv = new AsmMethodVisitor(cw2.visitMethod(ACC_PUBLIC, "accept", "(Lorg/xyy/net/http/WebSocket;Ljava/lang/Object;)V", null, null));
            ...
            {//虚拟accept函数
                ...
                mv.visitVarInsn(ALOAD, 0);
                mv.visitVarInsn(ALOAD, 1);
                mv.visitTypeInsn(CHECKCAST, "org/xyy/net/http/WebSocket");
                mv.visitVarInsn(ALOAD, 2);
                mv.visitTypeInsn(CHECKCAST, "java/lang/Object");
                mv.visitMethodInsn(INVOKEVIRTUAL, newDynConsumerFullName, "accept", "(Lorg/xyy/net/http/WebSocket;Ljava/lang/Object;)V", false);
                mv.visitInsn(RETURN);
                mv.visitMaxs(3, 3);
                mv.visitEnd();
            }
    ...
    static <T extends HttpServlet> T createRestServlet(final ClassLoader classLoader, final Class userType0, final Class<T> baseServletType, final Class<? extends Service> serviceType) {
        ...
        final String attrDesc = Type.getDescriptor(org.xyy.util.Attribute.class);
        ...
        final String attrInternalName = Type.getInternalName(org.xyy.util.Attribute.class);
        ...
        {  
            fv = cw.visitField(ACC_PRIVATE, "_xyy_home", Type.getDescriptor(File.class), null, null);
            av0 = fv.visitAnnotation("Ljavax/annotation/Resource;", true);
        ...
        final Map<String, org.xyy.util.Attribute> restAttributes = new LinkedHashMap<>();
        ...
        for (final MappingEntry entry : entrys) {
            ...
            if (mupload != null) { //存在文件上传
                if (muploadType == byte[].class) {
                    mv.visitVarInsn(ALOAD, 1);
                    mv.visitMethodInsn(INVOKEVIRTUAL, reqInternalName, "getMultiContext", "()Lorg/xyy/net/http/MultiContext;", false);
                    mv.visitLdcInsn(mupload.maxLength());
                    mv.visitLdcInsn(mupload.fileNameReg());
                    mv.visitLdcInsn(mupload.contentTypeReg());
                    mv.visitMethodInsn(INVOKEVIRTUAL, "org/xyy/net/http/MultiContext", "partsFirstBytes", "(JLjava/lang/String;Ljava/lang/String;)[B", false);
                    mv.visitVarInsn(ASTORE, maxLocals);
                } else if (muploadType == File.class) {
                    mv.visitVarInsn(ALOAD, 1);
                    mv.visitMethodInsn(INVOKEVIRTUAL, reqInternalName, "getMultiContext", "()Lorg/xyy/net/http/MultiContext;", false);
                    mv.visitVarInsn(ALOAD, 0);
                    mv.visitFieldInsn(GETFIELD, newDynName, "_xyy_home", "Ljava/io/File;");
                    mv.visitLdcInsn(mupload.maxLength());
                    mv.visitLdcInsn(mupload.fileNameReg());
                    mv.visitLdcInsn(mupload.contentTypeReg());
                    mv.visitMethodInsn(INVOKEVIRTUAL, "org/xyy/net/http/MultiContext", "partsFirstFile", "(Ljava/io/File;JLjava/lang/String;Ljava/lang/String;)Ljava/io/File;", false);
                    mv.visitVarInsn(ASTORE, maxLocals);
                    ...
                    mv.visitLdcInsn(mupload.fileNameReg());
                    mv.visitLdcInsn(mupload.contentTypeReg());
                    mv.visitMethodInsn(INVOKEVIRTUAL, "org/xyy/net/http/MultiContext", "partsFiles", "(Ljava/io/File;JLjava/lang/String;Ljava/lang/String;)[Ljava/io/File;", false);
                    mv.visitVarInsn(ASTORE, maxLocals);
                }
                maxLocals++;
            }
            ...
            for (Object[] ps : paramlist) {
                ...
                if (AsyncHandler.class.isAssignableFrom(ptype)) { //HttpResponse.createAsyncHandler() or HttpResponse.createAsyncHandler(Class)
                    if (ptype == AsyncHandler.class) {
                        mv.visitVarInsn(ALOAD, 2);
                        mv.visitMethodInsn(INVOKEVIRTUAL, respInternalName, "createAsyncHandler", "()Lorg/xyy/util/AsyncHandler;", false);
                        mv.visitVarInsn(ASTORE, maxLocals);
                        ...
                        mv.visitMethodInsn(INVOKEVIRTUAL, respInternalName, "createAsyncHandler", "(Ljava/lang/Class;)Lorg/xyy/util/AsyncHandler;", false);
                    ...
                    if (ptype == String.class) {
                        ...
                        String typefieldname = "_xyy_body_jsontype_" + bodyTypes.size();
                    ...
                    do {
                        ...
                        for (Field field : loop.getDeclaredFields()) {
                            ...
                            org.xyy.util.Attribute attr = org.xyy.util.Attribute.create(loop, field);
                            String attrFieldName;
                            String restname = "";
                            if (rh != null) {
                                attrFieldName = "_xyy_attr_header_" + restAttributes.size();
                                restname = rh.name();
                            } else if (rc != null) {
                                attrFieldName = "_xyy_attr_cookie_" + restAttributes.size();
                                restname = rc.name();
                            } else if (rs != null) {
                                attrFieldName = "_xyy_attr_sessionid_" + restAttributes.size();
                                restname = rs.create() ? "1" : ""; //用于下面区分create值
                            } else if (ra != null) {
                                attrFieldName = "_xyy_attr_address_" + restAttributes.size();
                                //restname = "";
                            } else if (rb != null && field.getType() == String.class) {
                                attrFieldName = "_xyy_attr_bodystring_" + restAttributes.size();
                                //restname = "";
                            } else if (rb != null && field.getType() == byte[].class) {
                                attrFieldName = "_xyy_attr_bodybytes_" + restAttributes.size();
                                //restname = "";
                            } else if (rb != null && field.getType() != String.class && field.getType() != byte[].class) {
                                attrFieldName = "_xyy_attr_bodyjson_" + restAttributes.size();
                                //restname = "";
                            } else if (ru != null && field.getType() == byte[].class) {
                                attrFieldName = "_xyy_attr_uploadbytes_" + restAttributes.size();
                                //restname = "";
                            } else if (ru != null && field.getType() == File.class) {
                                attrFieldName = "_xyy_attr_uploadfile_" + restAttributes.size();
                                //restname = "";
                            } else if (ru != null && field.getType() == File[].class) {
                                attrFieldName = "_xyy_attr_uploadfiles_" + restAttributes.size();
                                //restname = "";
                            } else if (ri != null && field.getType() == String.class) {
                                attrFieldName = "_xyy_attr_uri_" + restAttributes.size();
                                //restname = "";
                            } else {
                                continue;
                            }
        ...
        try {
            ...
            for (Map.Entry<String, org.xyy.util.Attribute> en : restAttributes.entrySet()) {
