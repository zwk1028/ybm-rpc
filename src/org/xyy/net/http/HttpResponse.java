...
public class HttpResponse extends Response<HttpContext, HttpRequest> {
    ...
    protected static final byte[] serverNameBytes = ("Server: xyy/" + XYYRPC.getDotedVersion() + "\r\n").getBytes();
    ...
    public AsyncHandler createAsyncHandler() {
        return AsyncHandler.create((v, a) -> {
            if (v instanceof org.xyy.service.RetResult) {
                finishJson((org.xyy.service.RetResult) v);
     ...
     */
    public void finishJson(final org.xyy.service.RetResult ret) {
        this.contentType = "text/plain; charset=utf-8";
     ...
     * @param ret     RetResult输出对象
     */
    public void finishJson(final JsonConvert convert, final org.xyy.service.RetResult ret) {
        this.contentType = "text/plain; charset=utf-8";
        if (this.recycleListener != null) this.output = ret;
        if (ret != null && !ret.isSuccess()) {
            this.header.addValue("retcode", String.valueOf(ret.getRetcode()));
    ...
    public void finishJson(final JsonConvert convert, final CompletableFuture future) {
        future.whenComplete((v, e) -> {
            ...
            if (v instanceof CharSequence) {
                finish(v.toString());
            } else if (v instanceof org.xyy.service.RetResult) {
                finishJson(convert, (org.xyy.service.RetResult) v);
            } else {
