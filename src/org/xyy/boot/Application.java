...
import org.xyy.net.TransportGroupInfo;
import java.io.*;
...
import org.xyy.convert.bson.BsonFactory;
import org.xyy.convert.json.JsonFactory;
import org.xyy.net.*;
import org.xyy.net.http.MimeType;
...
public final class Application {
    ...
    //根ClassLoader
    private final XYYURLClassLoader classLoader;

    //Server根ClassLoader
    private final XYYURLClassLoader serverClassLoader;
    ...
    private Application(final boolean singletonrun, final AnyValue config) {
        ...
        this.classLoader = new XYYURLClassLoader(Thread.currentThread().getContextClassLoader());
        //------------------配置 <transport> 节点 ------------------
        ...
        this.serverClassLoader = new XYYURLClassLoader(this.classLoader);
    }
    ...
    public XYYURLClassLoader getClassLoader() {
        return classLoader;
    }
