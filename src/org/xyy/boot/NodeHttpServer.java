...
public class NodeHttpServer extends NodeServer {
    ...
    protected ClassFilter<Service> createServiceClassFilter() {
        return createClassFilter(this.sncpGroup, null, Service.class, new Class[]{org.xyy.watch.WatchService.class}, Annotation.class, "services", "service");
    }
